        ...
        <div className="container">
            <div className="card mt-4">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">3. Use Google or your preferred stock website to compare the current price of the stock and compare it to the Graham Number displayed in this app. If the Graham Number is lower than the current price then that stock may be undervalued!</p>
